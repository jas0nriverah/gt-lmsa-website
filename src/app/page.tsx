  ...
  return (
    <SitePage>
      ...
      <Section
        ...
        description="Fall 2026 founding board roles. Three officers are confirmed; open chair applications open August 6, 2026. Only board information approved for public use is displayed."
        className="bg-gt-cream"
      >
