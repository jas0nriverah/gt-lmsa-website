  ...
  return (
    <SitePage>
      ...
      <Section
        ...
        description="Fall 2026 roles include President, Vice President / Operations, Outreach / Partnerships Chair, Events / Programming Chair, Service / Community Health Chair, Marketing / Communications Chair, Treasurer / Finance, and Secretary. Open Fall chairs begin accepting applications August 6, 2026. Membership / Mentorship is not opening yet. Roles and descriptions are intentionally limited to approved public chapter information."
        className="bg-gt-cream"
      >
