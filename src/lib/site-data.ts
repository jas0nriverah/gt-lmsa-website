...
export const announcements: Announcement[] = [
  ...
  },
  {
    ...
    timing: "September 1, 2026 · 11:00 AM – 1:00 PM · Tech Green",
    status: "confirmed",
    href: "/events",
    featured: true,
  },
...
export const linktreeLinks: ActionLink[] = [
  ...
  },
  {
    ...
    description: "Confirmed chapter events and GT academic dates.",
    href: "/events",
    status: "active",
    category: "Resources",
  },
  {
    ...
    description: "Advising links, scholarships, and opportunities.",
    href: "/resources",
    status: "active",
    category: "Resources",
  },
  {
    ...
    description: "Official GT advising, appointments, and Canvas.",
    href: "https://www.success.gatech.edu/pre-health/",
    status: "active",
    category: "Resources",
  },
  ...
  {
    label: "LMSA National",
    description: "Programs, membership, and national resources.",
    href: "https://national.lmsa.net/",
    status: "active",
    category: "LMSA",
  },
  {
    ...
    description: "Regional community for Georgia and the Southeast.",
    href: "https://southeast.lmsa.net/",
    status: "active",
    category: "LMSA",
  },
  {
    label: "Become an LMSA member",
    description: "National membership categories and benefits.",
    href: "https://national.lmsa.net/join/",
    status: "active",
    category: "LMSA",
  },
