 ...
 * Rechecked September 25, 2026 (weekday daily) against official GT Campus Calendar,
 * Pre-Health Advising, LMSA National, and LMSA Southeast sources.
 * No additional official-calendar pre-health events verified for Sep 25–Oct 9.
...
export const EXTERNAL_EVENTS_CHECKED_AT = "September 25, 2026";
